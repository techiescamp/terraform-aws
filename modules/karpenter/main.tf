...
data "aws_iam_policy_document" "controller" {
  ...
  source_policy_documents = [data.aws_iam_policy_document.v1[0].json] #var.enable_v1_permissions ? [data.aws_iam_policy_document.v1[0].json] : [data.aws_iam_policy_document.v033[0].json]
}
